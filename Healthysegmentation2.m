...
%     RMG_dataset = [dataset.(fields{1}).T_01.Clean.EMG.RMG; dataset.(fields{1}).T_02.Clean.EMG.RMG; dataset.(fields{1}).T_03.Clean.EMG.RMG];
    ...
    LTA_dataset = [filtfilt(b,a,dataset.(fields{1}).T_01.Raw.EMG.LTA); ...
        filtfilt(b,a,dataset.(fields{1}).T_02.Raw.EMG.LTA); ...
        filtfilt(b,a,dataset.(fields{1}).T_03.Raw.EMG.LTA)];
    
    RTA_dataset = [filtfilt(b,a,dataset.(fields{1}).T_01.Raw.EMG.RTA); ...
        filtfilt(b,a,dataset.(fields{1}).T_02.Raw.EMG.RTA); ...
        filtfilt(b,a,dataset.(fields{1}).T_03.Raw.EMG.RTA)];
    
    LMG_dataset = [filtfilt(b,a,dataset.(fields{1}).T_01.Raw.EMG.LMG); ...
        filtfilt(b,a,dataset.(fields{1}).T_02.Raw.EMG.LMG); ...
        filtfilt(b,a,dataset.(fields{1}).T_03.Raw.EMG.LMG)];
    
    RMG_dataset = [filtfilt(b,a,dataset.(fields{1}).T_01.Raw.EMG.RMG); ...
        filtfilt(b,a,dataset.(fields{1}).T_02.Raw.EMG.RMG); ...
        filtfilt(b,a,dataset.(fields{1}).T_03.Raw.EMG.RMG)];
