...
file = fullfile([pwd,'/Healthy Recordings/Subject1_2018/NO_FLOAT'],'S1_NO_FLOAT.mat');
data_healthy1 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject2_2018/NO_FLOAT'],'S2_NO_FLOAT.mat');
data_healthy2 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject3_2018/NO_FLOAT'],'S3_NO_FLOAT.mat');
data_healthy3 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject4_2018/NO_FLOAT'],'S4_NO_FLOAT.mat');
data_healthy4 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject5_2018/NO_FLOAT'],'S5_NO_FLOAT.mat');
data_healthy5 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject6_2018/NO_FLOAT'],'S6_NO_FLOAT.mat');
data_healthy6 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject1_2019/NO_FLOAT'],'S1_NO_FLOAT.mat');
data_healthy7 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject2_2019/NO_FLOAT'],'S2_NO_FLOAT.mat');
data_healthy8 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject3_2019/NO_FLOAT'],'S3_NO_FLOAT.mat');
data_healthy9 = load(file);

% Float - Healthy Subject
file = fullfile([pwd,'/Healthy Recordings/Subject1_2018/FLOAT'],'S1_FLOAT.mat');
data_healthy10 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject2_2018/FLOAT'],'S2_FLOAT.mat');
data_healthy11 = load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject3_2018/FLOAT'],'S3_FLOAT.mat');
data_healthy12= load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject4_2018/FLOAT'],'S4_FLOAT.mat');
data_healthy13= load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject5_2018/FLOAT'],'S5_FLOAT.mat');
data_healthy14= load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject6_2018/FLOAT'],'S6_FLOAT.mat');
data_healthy15= load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject1_2019/FLOAT'],'S1_FLOAT.mat');
data_healthy16= load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject2_2019/FLOAT'],'S2_FLOAT.mat');
data_healthy17= load(file);
file = fullfile([pwd,'/Healthy Recordings/Subject3_2019/FLOAT'],'S3_FLOAT.mat');
data_healthy18= load(file);

%% EMG Denoising 

% FLOAT_NO_CRUTCHES_NEW = denoising_EMG(data_float.FLOAT_NO_CRUTCHES_NEW,10);
% save([pwd,'/Exercise - Material - SCI Subject/FLOAT_NO_CRUTCHES_NEW/MAT/FLOAT_NO_CRUTCHES_NEW.mat'],'FLOAT_NO_CRUTCHES_NEW')
% NO_FLOAT_CRUTCHES_NEW = denoising_EMG(data_no_float.NO_FLOAT_CRUTCHES_NEW,10);
% save([pwd,'/Exercise - Material - SCI Subject/NO_FLOAT_CRUTCHES_NEW/MAT/NO_FLOAT_CRUTCHES_NEW.mat'],'NO_FLOAT_CRUTCHES_NEW')

S1_NO_FLOAT = denoising_EMG(data_healthy1.S1_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject1_2018/FLOAT'],'S1_NO_FLOAT');
S2_NO_FLOAT = denoising_EMG(data_healthy2.S2_NO_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject2_2018/NO_FLOAT'],'S2_NO_FLOAT');
S3_NO_FLOAT = denoising_EMG(data_healthy3.S3_NO_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject3_2018/NO_FLOAT'],'S3_NO_FLOAT');
S4_NO_FLOAT = denoising_EMG(data_healthy4.S4_NO_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject4_2018/NO_FLOAT'],'S4_NO_FLOAT');
S5_NO_FLOAT = denoising_EMG(data_healthy5.S5_NO_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject5_2018/NO_FLOAT'],'S5_NO_FLOAT');
S6_NO_FLOAT = denoising_EMG(data_healthy6.S6_NO_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject6_2018/NO_FLOAT'],'S6_NO_FLOAT');
S1_NO_FLOAT = denoising_EMG(data_healthy7.S1_NO_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject1_2018/NO_FLOAT'],'S1_NO_FLOAT');
...
save([pwd,'/Healthy Recordings/Subject1_2018/NO_FLOAT'],'S1_FLOAT');
S2_FLOAT = denoising_EMG(data_healthy11.S2_NO_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject2_2018/FLOAT'],'S2_FLOAT');
S3_FLOAT = denoising_EMG(data_healthy12.S3_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject3_2018/FLOAT'],'S3_FLOAT');
S4_FLOAT = denoising_EMG(data_healthy13.S4_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject4_2018/FLOAT'],'S4_FLOAT');
S5_FLOAT = denoising_EMG(data_healthy14.S5_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject5_2018/FLOAT'],'S5_FLOAT');
S6_FLOAT = denoising_EMG(data_healthy15.S6_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject6_2018/FLOAT'],'S6_FLOAT');
S1_FLOAT = denoising_EMG(data_healthy16.S1_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject1_2018/FLOAT'],'S1_FLOAT');
S2_FLOAT = denoising_EMG(data_healthy17.S2_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject2_2018/FLOAT'],'S2_FLOAT');
S3_FLOAT = denoising_EMG(data_healthy18.S3_FLOAT,10);
save([pwd,'/Healthy Recordings/Subject3_2018/FLOAT'],'S3_FLOAT');

%% Save Denoised variables

save([pwd,'/Exercise - Material - SCI Subject/FLOAT_NO_CRUTCHES_NEW/MAT/FLOAT_NO_CRUTCHES_NEW.mat'],'denoised_SCI_float')
