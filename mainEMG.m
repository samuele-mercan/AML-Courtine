...
if leftFoot   % if segmentation based on left foot
...
else % if segmentation based on left foot
...
save('parametersEMG_allbursts.mat', 'Param_Healthy_Float_Left', 'Param_Healthy_Float_left','Param_Healthy_NoFloat_Left', 'Param_Healthy_NoFloat_left','Param_SCI_Float_Left', 'Param_SCI_Float_left','Param_SCI_NoFloat_Left', 'Param_SCI_NoFloat_left');
